...
plot_wt_cond_1 = data_wt_cond_1 %>%
  ...
  coord_flip() +
  labs(
    title = "Frequency of Unusual Weather Conditions in Romania (Counts)",
    x = "",
...
```{r weather-types-plot-2, fig.width = 7, fig.height = 7, fig.align = 'center'}
...
total_occurrences = (data_wt_cond_2 %>% summarise(sum(Occurrences)))[[1]]

data_wt_cond_2 = data_wt_cond_2 %>%
  mutate(OccurrencesFreq = round(Occurrences / total_occurrences * 100, 2))

plot_wt_cond_2 = data_wt_cond_2 %>%
...
rm(data_wt_cond_2, data_wt_cond)
