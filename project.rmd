...
```{r}
compute_month_from_date = function(date_col) {
  month_col = substr(date_col, 1, 2)
  mapping = list(
    "01" = "January",
    "02" = "February",
...
rm(romania_map, romania_spdf, data_wt_cond_2, map_wt_cond_2)
```
...
- all of the 3 distributions tend to present 3 modes:
...
plot_temp_4 = ggplot(
    ...
    aes(
      ...
      y = Value,
      fill = Temperature,
      text = paste("Mean of", paste0(Temperature, "s:"), round(Value, 2), "°C")
    )
  ) +
  ...
  labs(
    ...
    y = "Daily Temperatures",
    x = ""
  )

ggplotly(plot_temp_4, tooltip = "text")

rm(plot_temp_4, data_temp_4)
```
